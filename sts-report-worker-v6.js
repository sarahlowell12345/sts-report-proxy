function getHTML() {
  ...
  parts.push('<div class="stat-chip alert"><div class="val" id="o-response-time"></div><div class="lbl">Avg response time</div></div>');
  parts.push('</div>');
  ...
  parts.push('var rep=d.reputation||{};');
  parts.push('var replyRate=rep.reviewReplyPercentage!=null?rep.reviewReplyPercentage:null;');
  parts.push('var responseTime=rep.averageResponseTime||"--";');
  parts.push('var negCount=rep.negativeReviewsFound||0;');
  ...
  parts.push('{label:"Hours of operation",val:!!(gmbData.openingHours||gmbData.hours)},');
