function getHTML() {
  ...
  parts.push('.report-header{background:#fff;padding:1.5rem;text-align:center;border-top:4px solid #1d3557;border-bottom:4px solid #1d3557}');
  parts.push('.sts-label{font-family:"Nunito Sans",sans-serif;font-size:22px;font-weight:700;color:#1d3557;margin-bottom:6px;letter-spacing:0;display:block}');
  parts.push('.biz-name{font-family:"Nunito Sans",sans-serif;font-size:14px;font-weight:400;color:#457b9d;letter-spacing:0.02em;display:block}');
  parts.push('.report-sub{display:none}');
  ...
  parts.push('.stat-chip.alert .val{color:#f4a261}');
  ...
  parts.push('<div class="report-header"><span class="sts-label">Streamlined Tech Systems</span><span class="biz-name" id="o-name"></span></div>');
  parts.push('<div class="report-body">');
  parts.push('<div class="opp-block"><div class="opp-head"><div class="opp-icon rep">&#9733;</div><div class="opp-title">Review follow-up opportunity</div></div>');
  ...
  parts.push('<div class="stat-chip alert"><div class="val" id="o-rep-score"></div><div class="lbl">Review activity score</div><div style="font-size:10px;color:#7a98ad;margin-top:2px;">61-80% = Good</div></div>');
  parts.push('<div class="stat-chip alert"><div class="val" id="o-neg-reviews"></div><div class="lbl">Unanswered reviews</div></div>');
  parts.push('</div>');
  parts.push('<div class="opp-line" id="o-rep-opp"></div>');
  parts.push('<div class="comp-wrap"><div class="sec-label">Local Google review context</div>');
  parts.push('<p style="font-size:12px;color:#7a98ad;margin-bottom:10px;line-height:1.6;">This snapshot reflects what potential customers may see when comparing nearby options on Google — not a judgment of service quality.</p>');parts.push('<table class="comp-table"><thead><tr><th>Business</th><th>Google reviews</th></tr></thead><tbody id="o-comp-body"></tbody></table>');
  parts.push('</div></div>');
  ...
  parts.push('var repScore=getScore(grades,"Online Reputation");');
  ...
  parts.push('document.getElementById("o-rep-score").textContent=repScore!==null?repScore+"%":"--";');
  parts.push('document.getElementById("o-neg-reviews").textContent=negReviews?negReviews+" unanswered":"0";');
  parts.push('var repOpp="";');
  parts.push('if(negReviews>3&&repScore!==null&&repScore<80){repOpp=biz+" already has review activity to build from. The main opportunity appears to be more consistent review follow-up and response tracking, especially on Google. A simple review request and notification system can make that easier to manage.";}');
  parts.push('else if(gmbTotal>0){repOpp="With "+Number(gmbTotal).toLocaleString()+" Google reviews and a "+Number(gmbRating).toFixed(1)+"-star rating, the review foundation is solid. The opportunity is in building volume and making sure every review gets a timely, on-brand response.";}');
  parts.push('else{repOpp="Building a strong review presence is one of the highest-impact steps a local business can take. Even a small number of recent, well-responded-to reviews can meaningfully improve local search ranking.";}');
  ...
  parts.push('if(!hasWebsite&&gbpScore!==null){gbpOpp="The profile scores "+gbpScoreDisplay+" with the main gap being a linked website. A linked website gives Google and potential customers another place to confirm business details, services, and next steps. It can also support a more complete local presence.";}');
  parts.push('else if(gbpScore!==null&&gbpScore>=80){gbpOpp="At "+gbpScoreDisplay+", the profile is in solid shape. Ongoing maintenance, keeping photos fresh, responding to Q&As, and posting updates, is what separates businesses that hold their ranking from those that gradually slip.";}');
