function getHTML() {
  ...
  parts.push('var allReviews=(d.reputation||[]);');
  parts.push('var totalReviews=allReviews.length;');
  parts.push('var repliedReviews=allReviews.filter(function(r){return r.status==="replied"||r.replied===true;}).length;');
  parts.push('var negReviews=allReviews.filter(function(r){return r.rating&&r.rating<=2;}).length;');
  parts.push('var replyRate=totalReviews>0?Math.round((repliedReviews/totalReviews)*100):null;');
