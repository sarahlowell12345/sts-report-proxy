function getHTML() {
  ...
  parts.push('</div>');
  parts.push('<hr class="sec-divider" />');
  parts.push('<div style="background:#eef3f7;border-radius:8px;padding:1.25rem 1.5rem;font-size:13px;color:#2b4a6b;line-height:1.7;font-style:italic;">This snapshot is part of a complimentary review of local businesses in the Fort Worth area. If anything here looks worth a conversation, we\'d love to connect.</div>');
  parts.push('</div>');
